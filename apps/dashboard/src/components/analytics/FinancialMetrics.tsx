...
import { FinancialAnalytics } from '@banking/shared-hooks';
        ...
        <Grid container spacing={3}>
                ...
                <Card>
                    <CardContent>
                        <Box display="flex" alignItems="center" mb={2}>
                            ...
                            <Typography variant="h6">Crescimento de Despesas</Typography>
                        </Box>
                        <Typography variant="h4" color={analytics.expenseGrowth <= 0 ? 'success.main' : 'error.main'}>
            ...
            <Grid>
                <Card>
                    <CardContent>
                        ...
                        <Typography variant="h4" color={analytics.savingsRate >= 0 ? 'success.main' : 'error.main'}>
                ...
                <Card>
                    <CardContent>
                        <Box display="flex" alignItems="center" mb={2}>
                            ...
                            <Typography variant="h6">Maior Receita</Typography>
                        </Box>
            ...
            <Grid>
                <Card>
                    <CardContent>
                        <Box display="flex" alignItems="center" mb={2}>
                            <AccountBalanceWallet color="error" sx={{ mr: 1 }} />
                            <Typography variant="h6">Maior Despesa</Typography>
                        </Box>
