...
const Image = dynamic(() => import("next/image"), {
  loading: () => <Box sx={{ width: 480, height: 480, bgcolor: "grey.100", borderRadius: 2 }} />,
  ssr: false,
});
...
export default function Login() {
  ...
  const handleLogin = useCallback(
    ...
    [email, password, router, setIsAuthenticated, setUserName]
  );
    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography variant="h5" mt={1} mb={2} color="primary">
            Banco Simples
          </Typography>
