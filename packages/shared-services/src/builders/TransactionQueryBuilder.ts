...
export class TransactionQueryBuilder {
	...
	filterByCategories(categories?: string[]): TransactionQueryBuilder {
		...
		this.query.filters.categories = categories;
		return this;
	}
	...
	filterByDateRange(
		...
		this.query.filters.startDate = startDate;
		this.query.filters.endDate = endDate;
		return this;
	}
	...
	static withDefaults(): TransactionQueryBuilder {
		return new TransactionQueryBuilder({ page: 1, limit: 10 }).sortBy(
			"date",
			"desc",
		);
	}
